...
generateQuiz(Pergunta, quizContainer, resultsContainer, submitButton);
...
function generateQuiz(questions, quizContainer, resultsContainer, submitButton){
	...
	function showResults(questions, quizContainer, resultsContainer){
		...
		for(var i=0; i<questions.length; i++){
			...
			resultsContainer.innerHTML = `${numCorrect} Respostas certas de ${questions.length} Questões <br> Sua Pontuação: ${Pontos}`
		}
