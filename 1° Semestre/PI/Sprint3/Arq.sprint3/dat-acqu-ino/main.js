...
const serial = async (
    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        const sens1 = parseInt(valores[1]);
        const sens2 = parseInt(valores[2]);
        const sens3 = parseInt(valores[3]);
        const sens4 = parseInt(valores[4]);
        const sens5 = parseInt(valores[5]);
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            if (AMBIENTE == 'producao') {
                ...
                await poolBancoDados.execute(
                    `INSERT INTO leitura (status) VALUES (${sens1}), (${sens2}), (${sens3}), (${sens4}), (${sens5})`,
