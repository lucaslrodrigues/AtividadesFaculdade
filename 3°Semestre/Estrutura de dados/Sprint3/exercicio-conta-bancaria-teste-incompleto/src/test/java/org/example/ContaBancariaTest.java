...
public class ContaBancariaTest {
    ...
    public void depositarQuandoValorNuloOuZeroOuNegativoRetornaIllegalArgumentException(){
        ContaBancaria contaTest = new ContaBancaria(123, 150.00);
        assertThrows(IllegalArgumentException.class, () -> contaTest.creditar(null));
        assertThrows(IllegalArgumentException.class, () -> contaTest.creditar(0.0));
        assertThrows(IllegalArgumentException.class, () -> contaTest.creditar(-10.0));
    }
}
